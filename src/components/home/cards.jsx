...
export default function Cards() {
  ...
  return (
    <>
        <div className="grid lg:grid-cols-3 sm:grid-cols-2  grid-cols-1 gap-6 px-3 w-[100%] ">
      {products.map((product) => (
        ...
        >
          ...
          <button className="my-5 px-4 py-3 bg-[#2F8EFF] text-white rounded-lg hover:bg-blue-600" onClick={() => {
